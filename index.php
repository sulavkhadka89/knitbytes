    ...
    <div class="container-fluid px-lg-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="text-white pb-3 animated slideInDown"><?php echo $_settings->info('name') ?></h1>
                <p class="text-white pb-3 animated slideInDown"><?php echo stripslashes($_settings->info('welcome_message')) ?></p>
    ...
    <div class="container-fluid py-5 px-lg-5">
        <div class="row justify-content-center">
            <div class="col-lg-7 text-center">
                ...
                <p class="text-white mb-4">Subscribe to our newsletter for the latest updates and news.</p>
                ...
                <form method="post" action="subscribe.php">
                    <div class="position-relative w-100 mt-3">
                        ...
                        <button type="submit" name="submit" class="btn shadow-none position-absolute top-0 end-0 mt-1 me-2">
                ...
                <?php if (isset($_GET['success'])): ?>
                    <p class="text-white mt-3">✅ Thank you for subscribing!</p>
                <?php elseif (isset($_GET['error'])): ?>
                    <p class="text-danger mt-3">❌ Failed to subscribe. Try again.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
