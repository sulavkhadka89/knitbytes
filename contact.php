                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            <p class="text-center mb-4">Please Use Your Email correctly so that we can contact you.</a>.</p>
                                <form id="contactForm" action="" method="POST" class="contact_form">
    <div class="form_name">
        <div class="form-group">
            <label for="full_name" class="control-label text-black">Full Name</label>
            <input type="text" class="form-control" id="full_name" name="full_name" required>
        </div>
        <div class="form-group">
            <label for="email" class="control-label text-black">Email</label>
            <input type="email" class="form-control" id="email" name="email" required>
        </div>
        <div class="form-group">
            <label for="contact_no" class="control-label text-black">Phone Number</label>
            <input type="text" class="form-control" id="contact_no" name="contact" required>
        </div>
        <div class="form-group">
            <label for="subject" class="control-label text-black">Subject</label>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-envelope me-3"></i></i><?php echo $contact['email'] ?></p>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p>Stay updated with the latest trends, insights, and offers in the tech world by subscribing to our newsletter!</p>
